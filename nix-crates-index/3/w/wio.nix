...
rec {
  ...
  wio_0_1_1 = buildCratesLib {
    ...
    deps = with allCrates; [  all__user32-sys.user32-sys_0_1 all__kernel32-sys.kernel32-sys_0_2 all__winapi.winapi_0_2 ];
  };
  wio_0_1_2 = buildCratesLib {
    name = "wio";
    version = "0.1.2";
    hash = "ae5a4e42c0d7f399771f3f2f7b56d22e0a51e5915c9d8f7b5bf7e1b8e056fc3d";
    deps = with allCrates; [  all__winapi.winapi_0_2 all__user32-sys.user32-sys_0_1 all__advapi32-sys.advapi32-sys_0_2 all__kernel32-sys.kernel32-sys_0_2 ];
  };
  "wio_0_1" = wio_0_1_2;
  "wio_0" = wio_0_1_2;}