...
{buildCratesLib, allCrates}:
{
  ...
  czt_0_3_3 = buildCratesLib {
    ...
    deps = with allCrates; [ dft num-complex num-traits ];
  };
  ...
  czt_0_3_5 = buildCratesLib {
    ...
    deps = with allCrates; [ num-traits dft num-complex ];
  };}