...
rec {
  ...
  prometheus_0_2_0 = buildCratesLib {
    ...
    deps = with allCrates; [  all__lazy_static.lazy_static_0_2 all__protobuf.protobuf_1_0 all__quick-error.quick-error_0_2 all__fnv.fnv_1_0_3 ];
  };
  "prometheus_0_1" = prometheus_0_1_0;
  prometheus_0_2_1 = buildCratesLib {
    name = "prometheus";
    version = "0.2.1";
    hash = "25bde48c257af33ea5e9daf86620288d5ca8bb24590a38528c7cc6e78ee8afe7";
    deps = with allCrates; [  all__lazy_static.lazy_static_0_2 all__fnv.fnv_1_0_3 all__protobuf.protobuf_1_0 all__quick-error.quick-error_0_2 ];
  };
  prometheus_0_2_2 = buildCratesLib {
    name = "prometheus";
    version = "0.2.2";
    hash = "9f673fa9967358a117b09160700eaa22ece396b1f2204f94d64adfd7a3b7b641";
    deps = with allCrates; [  all__protobuf.protobuf_1_0 all__fnv.fnv_1_0_3 all__quick-error.quick-error_0_2 all__lazy_static.lazy_static_0_2 ];
  };
  prometheus_0_2_3 = buildCratesLib {
    name = "prometheus";
    version = "0.2.3";
    hash = "93fd1604ea14beb12cce75ab3976ea748800fa60e52f326ab6cb6cece76de5c3";
    deps = with allCrates; [  all__lazy_static.lazy_static_0_2 all__quick-error.quick-error_0_2 all__protobuf.protobuf_1_0 all__fnv.fnv_1_0_3 ];
  };
  prometheus_0_2_5 = buildCratesLib {
    name = "prometheus";
    version = "0.2.5";
    hash = "99fc9366f943c58a5ccc5fa1bcf13887e7f30e7376c412e694cf8b18e38626ad";
    deps = with allCrates; [  all__lazy_static.lazy_static_0_2 all__quick-error.quick-error_0_2 all__fnv.fnv_1_0_3 all__protobuf.protobuf_1_0 ];
  };
