...
rec {
  gpgme-sys_0_1_0 = buildCratesLib {
    ...
    deps = with allCrates; [  enum_primitive all__libgpg-error-sys.libgpg-error-sys_0_1 all__libc.libc_0_1 ];
  };
  ...
  "gpgme-sys_0_1" = gpgme-sys_0_1_1;
  "gpgme-sys_0_2" = gpgme-sys_0_2_0;
  "gpgme-sys_0" = gpgme-sys_0_2_0;}