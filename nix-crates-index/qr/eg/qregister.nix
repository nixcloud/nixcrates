...
{buildCratesLib, allCrates}:
{
  ...
  qregister_0_2_1 = buildCratesLib {
    ...
    deps = with allCrates; [ qindex_multi rustc-serialize qdowncast ];
  };
  qregister_0_2_2 = buildCratesLib {
    name = "qregister";
    version = "0.2.2";
    hash = "e2c5304a4b1720e1223d4c678a8e1145f4863870f9f0d5ca0ac82c80fc994078";
    deps = with allCrates; [ qdowncast rustc-serialize qindex_multi ];
  };}