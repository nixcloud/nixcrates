...
rec {
  llvm_build_utils_0_1_0 = buildCratesLib {
    ...
    deps = with allCrates; [  all__mktemp.mktemp_0_2 all__libc.libc_0_2 ];
  };
  ...
  "llvm_build_utils_0_1" = llvm_build_utils_0_1_0;
  llvm_build_utils_0_3_0 = buildCratesLib {
    name = "llvm_build_utils";
    version = "0.3.0";
    hash = "f4a9b059360bd14a698feef2f589fcf5a3e62f42b1651f7207a5b2fba3cd9821";
    deps = with allCrates; [  all__libc.libc_0_2 all__mktemp.mktemp_0_2 all__target_build_utils.target_build_utils_0_1 ];
  };
  "llvm_build_utils_0_2" = llvm_build_utils_0_2_0;
  "llvm_build_utils_0_3" = llvm_build_utils_0_3_0;
  "llvm_build_utils_0" = llvm_build_utils_0_3_0;}