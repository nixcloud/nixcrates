...
rec {
  ...
  "bulletinboard_0_1" = bulletinboard_0_1_3;
  ...
  "bulletinboard_0_2" = bulletinboard_0_2_1;
  ...
  "bulletinboard_0_3" = bulletinboard_0_3_1;
  bulletinboard_0_4_1 = buildCratesLib {
    name = "bulletinboard";
    version = "0.4.1";
    hash = "5df47507bc3179d512e42c32eee0a5dd3dfbddd338b69c957a3e63412b6e4037";
    deps = with allCrates; [  all__rustc-serialize.rustc-serialize_0_3 all__rand.rand_0_3 all__env_logger.env_logger_0_3 all__log.log_0_3 all__rust-crypto.rust-crypto_0_2 all__docopt.docopt_0_6 ];
  };
  "bulletinboard_0_4" = bulletinboard_0_4_1;
  "bulletinboard_0" = bulletinboard_0_4_1;}