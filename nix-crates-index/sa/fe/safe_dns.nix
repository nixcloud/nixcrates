...
{buildCratesLib, allCrates}:
{
  ...
  safe_dns_0_3_1 = buildCratesLib {
    ...
    deps = with allCrates; [ routing sodiumoxide rustc-serialize safe_nfs safe_core log ];
  };
  safe_dns_0_4_0 = buildCratesLib {
    name = "safe_dns";
    version = "0.4.0";
    hash = "62ae60c9c34bbad91738d9b4c2cdb78fee3fcc5eb73303def5483c40826e44ec";
    deps = with allCrates; [ maidsafe_utilities safe_core log safe_nfs rustc-serialize sodiumoxide routing xor_name ];
  };
  safe_dns_0_5_0 = buildCratesLib {
    name = "safe_dns";
    version = "0.5.0";
    hash = "0bfc18e919fc363d22780a004282f4ff256a26e56eec133432fb0a16eb6cec84";
    deps = with allCrates; [ routing maidsafe_utilities sodiumoxide log safe_core rustc-serialize safe_nfs xor_name ];
  };
  safe_dns_0_6_0 = buildCratesLib {
    name = "safe_dns";
    version = "0.6.0";
    hash = "fce32bf5aefe57b02d8d27f4c1a2752f03ea1bde5036be7ab674805985f8e706";
    deps = with allCrates; [ maidsafe_utilities xor_name log sodiumoxide routing safe_nfs rustc-serialize safe_core ];
  };}